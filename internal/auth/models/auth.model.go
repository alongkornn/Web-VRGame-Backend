...
type User struct {
	...
	CurrentCheckpoint   string   `json:"current_checkpoint,omitempty" firestore:"current_checkpoint,omitempty"`
	CompletedCheckpoints []string `json:"completed_checkpoints,omitempty" firestore:"completed_checkpoints,omitempty"`
